...
static string sai_vlan_port_tagging_mode_str_get (sai_vlan_tagging_mode_t mode)
{
    ...
    {
        {SAI_VLAN_PORT_UNTAGGED, "\"UNTAGGED\""},
        {SAI_VLAN_PORT_TAGGED, "\"TAGGED\""},
        {SAI_VLAN_PORT_PRIORITY_TAGGED, "\"PRIORITY-TAGGED\""}
    };
                                      ...
                                      uint_t metadata)
{
    ...
    string is_static_str = (entry_type == SAI_FDB_ENTRY_STATIC)? "1" : "0";
                                            ...
                                            sai_fdb_flush_entry_type_t flush_type)
{
    ...
    if (flush_type == SAI_FDB_FLUSH_ENTRY_DYNAMIC) {
        is_static_str = "0";
    } else if (flush_type == SAI_FDB_FLUSH_ENTRY_STATIC) {
        is_static_str = "1";
    } else {
