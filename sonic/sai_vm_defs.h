...
typedef struct _sai_vm_tcb_t {
    ...
    uint8_t         *acl_entry_id_bitmap [SAI_ACL_TABLE_ID_MAX];
...
static inline uint8_t *sai_vm_access_acl_entry_bitmap (uint_t table_id)
{
    return (sai_vm_access_tcb()->acl_entry_id_bitmap [table_id]);
}
