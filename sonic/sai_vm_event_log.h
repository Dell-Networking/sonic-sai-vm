...
#define SAI_VM_DB_LOG_TRACE(msg, ...) \
            SAI_VM_DB_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_VM_DB_LOG_CRIT(msg, ...) \
            SAI_VM_DB_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_VM_DB_LOG_ERR(msg, ...) \
            SAI_VM_DB_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_VM_DB_LOG_INFO(msg, ...) \
            SAI_VM_DB_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_VM_DB_LOG_WARN(msg, ...) \
            SAI_VM_DB_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_VM_DB_LOG_NTC(msg, ...) \
            SAI_VM_DB_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)
